...
#2.modified: changed, not committed.
#3.staged: the current version of the file will go in the next commit.
...
#you add something for commit changes, but edit it after you add it, the version from when you added it will be commited instead of your recently edited one.
